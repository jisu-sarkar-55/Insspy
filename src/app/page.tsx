        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            {[
              ...
              <Reveal key={plan.tier} delay={plan.highlighted ? 1 : 0}>
                <div
                  className={`rounded-xl border p-7 relative ${plan.highlighted ? "animate-glow-pulse" : ""}`}
                  style={{
                    borderColor: plan.highlighted ? "rgba(251, 191, 36, 0.3)" : "rgba(160, 135, 90, 0.2)",
                    background: plan.highlighted ? "rgba(251, 191, 36, 0.03)" : "var(--surface-card)",
                  }}
                >
                  {plan.highlighted && (
                    <div
                  ...
                  <Link href="/auth/signup" className="block">
                    <Button
                      ...
                      size="lg"
                    >
                      {plan.highlighted ? "Start Premium" : "Get Started Free"}
                    </Button>
                  </Link>
                </div>
              </Reveal>
